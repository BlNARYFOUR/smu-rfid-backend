...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        VehicleOwner::create(['is_vip' => true, 'first_name' => 'Jane', 'middle_name' => 'Jennifer', 'last_name' => 'Doe', 'phone_number' => '09 (123) 45 67 89', 'address' => 'Capital, Bayombong, 3700', 'picture' => 'images/vehicle_owners/owner_2.jpg', 'owner_type_id' => 2,]);

        VehicleType::create(array('name' => 'car'));
        VehicleType::create(array('name' => 'motorcycle'));
        VehicleType::create(array('name' => 'bus'));

        Vehicle::create(['vehicle_type_id' => 1, 'model' => 'Toyota', 'plate_number' => 'ABC123', 'or_number' => '123456', 'cr_number' => '7654321', 'licence_number' => '1234567', 'rfid_tag' => 'E2003032761300940260ED01', 'vehicle_owner_id' => 1, 'activated_at' => now(),]);
        Vehicle::create(['vehicle_type_id' => 2, 'model' => 'Kawasaki Ninja H2R', 'plate_number' => 'XYZ890', 'or_number' => '654321', 'cr_number' => '1234567', 'licence_number' => '7654321', 'rfid_tag' => 'E2001027680901430350E92F', 'vehicle_owner_id' => 2, 'activated_at' => now()->subYears(1)->subMonth(),]);
